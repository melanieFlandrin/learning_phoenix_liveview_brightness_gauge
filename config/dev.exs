...
config :learning_phoenix_liveview_brightness_gauge, LearningPhoenixLiveviewBrightnessGauge.Repo,
  username: "postgres",
  password: "postgres",
  database: "learning_phoenix_liveview_brightness_gauge_dev",
  hostname: "localhost",
...
config :learning_phoenix_liveview_brightness_gauge, LearningPhoenixLiveviewBrightnessGaugeWeb.Endpoint,
  live_reload: [
    patterns: [
      ...
      ~r"priv/gettext/.*(po)$",
      ~r"lib/learning_phoenix_liveview_brightness_gauge_web/(live|views)/.*(ex)$",
      ~r"lib/learning_phoenix_liveview_brightness_gauge_web/templates/.*(eex)$"
    ]
  ]
